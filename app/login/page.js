      ...
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          <div className="max-w-md mx-auto">
            <div>
              <h1 className="text-2xl font-semibold text-center">Let's log you in</h1>
            </div>
            <div className="divide-y divide-gray-200">
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="relative text-center">
                  <button className="bg-[#834CFF] text-white rounded-md px-2 py-1 mt-4">Login</button>
                </div>
              </div>
            </div>
            <Link href="/register" className="text-[#834CFF] block text-center mb-2">Don't have an account? Register Now!</Link>
            <Link href="/forgot" className="text-[#777] block text-center">Forgot Password?</Link>
          </div>
        </div>
      </div>
    </div>
