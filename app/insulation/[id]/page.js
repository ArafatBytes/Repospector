    ...
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="flex justify-between items-start mb-8">
          {/* Company Info - Left */}
          <div>
            <h1 className="text-[#0066A1] text-2xl font-bold mb-1">SHAHRISH</h1>
          ...
          <div className="text-sm text-right">
            ...
            <p>
              LONG ISLAND OFFICE: 535 BROADHOLLOW ROAD, SUITE# 87, MELVILLE, NY
              11747, T: (631) 393 6020
            </p>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="font-bold mb-2">INSPECTION OBSERVATIONS/REMARKS:</h3>
